...
export default function Home() {
  ...
  return <main ref={root} className={motionOff ? "motion-off" : ""}>
    ...
    <section className="hero" id="main-content">
      <div className="hero-copy"><p className="eyebrow intro-enter">YOU’RE FREE. NOW WHAT?</p><h1 aria-label="Go out."><span className="type-line"><span>GO</span></span><span className="type-line"><span>OUT.</span></span></h1><div className="hero-bottom intro-enter"><p>At least three things worth going out for.<br/>Nearby. Ready right now.</p><div className="cta-row"><a className="button" href="#waitlist">I’m in</a><span className="free-note">OutRN is free. Always.</span></div><span className="launch-note">Coming soon. One neighborhood at a time.</span></div></div>
    ...
    <section className="the-idea" id="the-idea">
      <div className="idea-intro reveal"><p className="eyebrow">SKIP THE SEARCH.</p><div className="idea-explanation"><p>Open the app.<br/><strong>Your options are already there.</strong></p><p className="optional-filters">Got a budget or a time limit? Add it if you want.</p></div></div>
